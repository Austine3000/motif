...
- `VERTICAL_REF` = check if `.claude/get-motif/references/verticals/{VERTICAL}.md` exists
...
- `.planning/design/DESIGN-BRIEF.md`
  {IF VERTICAL_REF EXISTS: - `.claude/get-motif/references/verticals/{VERTICAL}.md`}
